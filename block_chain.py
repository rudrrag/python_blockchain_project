...
class Blockchain(object):
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            # Check that the Proof of Work is corrct
    ...
    def resolve_conflicts(self):
        """
        Consus Algorithm, it resolves conflicts by
        replacing our chain with the longest one in the
        network.
        :return: <bool> True if out chain was replaced,
        False if not
        """
